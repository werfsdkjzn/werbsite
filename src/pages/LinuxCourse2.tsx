...
import { linuxTasks2 } from '../data/linuxCourse2';
import TaskContent from '../components/TaskContent';
import TaskList from '../components/TaskList';
import ProgressHeader from '../components/ProgressHeader';
import CongratsScreen from '../components/CongratsScreen';

export default function LinuxCourse2() {
  ...
  const calculateProgress = () => {
    ...
    return (completedCount / linuxTasks2.length) * 100;
  };

  const handleNextTask = () => {
    if (currentTask < linuxTasks2.length - 1) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-gray-100 to-gray-200">
      <ProgressHeader
        title="Linux Avançado"
        subtitle="Domine conceitos avançados de administração e segurança Linux"
          ...
          <div className="grid md:grid-cols-[300px,1fr] gap-6">
            ...
            <TaskContent
              ...
              onAnswerSelect={(questionIndex: number, choiceId: string) => {
                ...
                const allQuestionsCorrect = linuxTasks2[currentTask].questions.every(question => {
              ...
              isLast={currentTask === linuxTasks2.length - 1}
            />
          </div>
        ) : (
